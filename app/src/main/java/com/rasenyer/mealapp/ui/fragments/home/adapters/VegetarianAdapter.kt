...
import com.rasenyer.mealapp.databinding.ItemVegetarianBinding
import com.rasenyer.mealapp.ui.fragments.home.HomeFragmentDirections

class VegetarianAdapter: RecyclerView.Adapter<VegetarianAdapter.MyViewHolder>() {

    private var categoryList = ArrayList<Category>()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        return MyViewHolder(ItemVegetarianBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }
    ...
    class MyViewHolder(val binding: ItemVegetarianBinding): RecyclerView.ViewHolder(binding.root)
